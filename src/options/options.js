...
const genericPageMaxCharsEl = document.getElementById('genericPageMaxChars');
  ...
  chrome.storage.sync.set(
    {
      ...
      genericPageMaxChars: genericPageMaxCharsEl.value,
      blockTemplates,
    },
    () => {
